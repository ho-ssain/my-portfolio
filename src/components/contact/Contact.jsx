        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">awarehossain@gmail.com</span>
              <a
            ...
            <div className="contact-card">
              ...
              <h3 className="contact-card-title">WhatsUp</h3>
              <span className="contact-card-data">01871074170</span>
              <a
                href="https://api.whatsup.com/send?phone=01871074170&text=Hello👋"
                className="contact-button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">@awarehossain</span>
              <a
